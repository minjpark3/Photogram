...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		//formData객체를 이용하려면 form태그의 필드와 그 값을 나타내는 일련으 key/value 쌍을 담을 수 있다.
		...
		$.ajax({
			...
			data:formData,
			contentType:false, //필수:지정안하면 x=www.form-urlencoded로 파싱되는것 방지
			processData: false, //필수 :contentType을 false로 주면 QueryString으로 자동 설정됨 .해제
